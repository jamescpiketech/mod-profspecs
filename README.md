...
Adds an NPC that will teach characters additional specializations for tradeskills (such are Armorsmithing and Weaponsmithing).

Features:
- Toggle on and off for each tradeskill.
- Add a gold cost to learning specializations. 

Planned:
- Toggle for subspecs (Swordsmith, Hammersmith, Axesmith)

## How to install
1. Put the module under the modules folder in your AzerothCore source folder.
